...
*/
        ...
        System.out.println(Stringa.pippo);
        System.out.println(laMiaStringa1.larghezza);
...
/*        Integer intObj1 = new Integer(valoreIntero);
        ...
        Double doubObj4 = Double.valueOf(10.5); //static
        Float floatObj4 = Float.valueOf(10.5F);

        int valoreIntero8 = intObj4.valueOf(100);

        // trasformazione da Wrapper Class a primitivo
        int valoreIntero1 = intObj4.intValue();
        double valoreDoppiaPrec1 = doubObj4.doubleValue(); //public
        float valoreFloat1 = floatObj4.floatValue();
