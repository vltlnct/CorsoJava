...
/*
 La lista contiene Auto e Moto
 Inoltre gli elementi, grazie all'uso di ArrayList vengoo aggiutni dinamicamente
 */
public static void gestioneAutoveicoli(){
        ConcessionarioAutoVeicoli concessionario = new ConcessionarioAutoVeicoli(5);
